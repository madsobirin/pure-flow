...
export default function LoginPage() {
  ...
  const handleLoginSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        setErrors({
          global: result.message || "Email atau password salah.",
        });
        return;
      }
      ...
      setErrors({
        global: "Gagal terhubung ke server. Pastikan koneksi aman.",
      });
    } finally {
      setIsLoading(false);
    }
      ...
      >
        ...
        >
          <form onSubmit={handleLoginSubmit} className="space-y-5">
            {/* Global Error Notice jika kredensial salah / server bermasalah */}
            {errors.global && (
