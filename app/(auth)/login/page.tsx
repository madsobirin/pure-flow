...
export default function LoginPage() {
  const [currentMode, setCurrentMode] = useState<"login" | "success">("login");
  ...
  const [registeredAccounts] = useState<UserProfile[]>([
    { namaLengkap: "Alex Johnson", email: "alex@example.com" },
    { namaLengkap: "Ahmad Sobirin", email: "ahmadsobirin67834@gmail.com" },
  ]);
                ...
                <div className="pt-2 border-t border-gray-100">
                  <p className="text-xs text-gray-500 flex items-center gap-1.5 font-medium leading-relaxed">
                    ...
                    <span>
                      ...
                      fungsionalitas visual login akun Anda.
                    </span>
                  </p>
                </div>
              </div>
