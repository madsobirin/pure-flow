  ...
  return (
    <div className="mb-6">
      <div className="flex items-center justify-between mb-4">
        ...
        <button className="text-brand-teal font-bold text-sm hover:underline cursor-pointer">
          See All
        </button>
      </div>
      ...
      {activities.length === 0 ? (
        <div className="text-center py-8 bg-field-bg rounded-[24px] border border-dashed border-gray-200">
          <p className="text-xs text-gray-500 font-semibold mb-1">Belum ada latihan dicatat</p>
          <p className="text-[10px] text-gray-400">Silakan catat latihan pertama Anda hari ini.</p>
        </div>
      ) : (
